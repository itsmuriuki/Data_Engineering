...
time_table_insert = ("""INSERT INTO time(start_time, hour, day, week, month, year, weekday)
 ...
 ON CONFLICT (start_time) DO UPDATE SET hour= time.hour, day= time.day, week = time.week, month= time.month, year= time.year, weekday=time.weekday """)

#Find song by song_id and artist_id 
...
#QUERY LIST 
create_table_queries = [users_table_create, songs_table_create, artist_table_create, time_table_create, songplay_table_create]
drop_table_queries = [users_table_drop, song_table_drop, artist_table_drop, time_table_drop, songplay_table_drop]
